...
function Left({ currentPay, pay, asDevSetter, asDevloper, setPage }) {
  return (
    <>
      <div
        className="left w-full md:w-12/25 bg-blue_grey px-4 py-5 md:px-8 md:py-12 border-2 border-solid border-grey_50 rounded-lg"
        style={{ width: "40.5%" }}
      >
